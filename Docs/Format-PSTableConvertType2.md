...
```
Format-PSTableConvertType2 [[-Object] <Object>] [-SkipTitles] [[-Property] <String[]>]
 [[-ExcludeProperty] <String[]>] [-NoAliasOrScriptProperties] [-DisplayPropertySet]
 [[-OverwriteHeaders] <Object>] [-PreScanHeaders] [<CommonParameters>]
```
