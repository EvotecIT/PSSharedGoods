...
@{
    ...
    RequiredModules = @(@{ModuleName = 'PSWriteColor'; GUID = '0b0ba5c5-ec85-4c2b-a718-874e55a8bc3f'; ModuleVersion = '0.85'; })
    ...
    'Get-ComputerStartup', 'Get-ComputerSystem', 
    'Get-ComputerWindowsFeatures', 'Get-ComputerWindowsUpdates', 
    'Get-ServerRoles', 'Connect-WinAzure', 'Connect-WinAzureAD', 
    ...
    'Disconnect-WinTeams', 'Get-IPAddressInformation', 'Get-MyIpAddress', 
    'Install-WinConnectity', 'Request-Credentials', 
    ...
    'ConvertFrom-SID', 'ConvertFrom-X500Address', 'ConvertTo-ImmutableID', 
    ...
    'New-GenericList', 'Remove-DuplicateObjects', 'Remove-FromArray', 
    'Remove-ObjectsExistingInTarget', 'Remove-WhiteSpace', 
    'Rename-LatinCharacters', 'Rename-UserValuesFromHash', 'Split-Array', 
    'Split-ArrayEvery', 'Find-MyProgramData', 'Get-InstalledApplication', 
    'Install-ApplicationClickOnce', 'Start-MyProgram', 
    'Test-InstalledApplication', 'Uninstall-ApplicationClickOnce', 
    'Get-RandomCharacters', 'Get-RandomFileName', 'Get-RandomPassword', 
    ...
    'Convert-FromColor', 'Set-EmailBodyTableReplacement', 
