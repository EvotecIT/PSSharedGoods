...
@{
    ...
    'Get-Types', 'Import-PrivateModule', 'Merge-Array', 'Merge-Objects', 
    'New-ArrayList', 'New-GenericList', 'Remove-DuplicateObjects', 
    'Remove-EmptyValues', 'Remove-FromArray', 
    'Remove-ObjectsExistingInTarget', 'Remove-WhiteSpace', 
    'Rename-LatinCharacters', 'Rename-UserValuesFromHash', 
    'Select-Properties', 'Split-Array', 'Split-ArrayEvery', 
    'Find-MyProgramData', 'Initialize-ModulePortable', 
