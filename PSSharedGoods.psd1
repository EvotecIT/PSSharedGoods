...
@{
    ...
    'Get-ComputerCPU', 'Get-ComputerDisk', 'Get-ComputerDiskLogical', 
    ...
    'Get-ComputerSystem', 'Get-ComputerTime', 'Get-ComputerTimeNtp', 
    ...
    'Compare-TwoArrays', 'Compare-ObjectsAdvanced', 
    ...
    'Format-View', 'Get-DataInformation', 'Get-HashMaxValue', 
    ...
    'Rename-UserValuesFromHash', 'Select-Properties', 'Select-Unique', 
    'Split-Array', 'Split-ArrayEvery', 'Find-MyProgramData', 
    'Initialize-ModulePortable', 'Get-RequiredModule', 'Start-MyProgram', 
    'Get-RandomCharacters', 'Get-RandomFileName', 'Get-RandomPassword', 
    'Get-RandomStringName', 'Get-CommandInfo', 'New-Runspace', 
    'Start-Runspace', 'Stop-Runspace', 'Get-PSRegistry', 
    ...
    'Test-WinRM', 'Get-TimeSetttings', 'Get-TimeZoneLegacy', 
    'Measure-Collection', 'Set-TimeSynchronization', 'Start-TimeLog', 
