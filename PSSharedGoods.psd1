...
FunctionsToExport = 'Add-WinADUserGroups', 'Get-WinADOrganizationalUnitData', 
               ...
               'Format-Stream', 'Format-ToTitleCase', 'Format-ToTitleCaseSentence', 
               'Format-TransposeTable', 'Format-Verbose', 'Get-HashMaxValue', 
               'Get-MimeType', 'Get-ObjectCount', 'Get-ObjectData', 'Get-ObjectKeys', 
               'Get-ObjectProperties', 'Get-ObjectPropertiesAdvanced', 
               'Get-ObjectTitles', 'Get-ObjectType', 'Get-Types', 'Merge-Objects', 
               'New-ArrayList', 'Remove-DuplicateObjects', 'Remove-FromArray', 
