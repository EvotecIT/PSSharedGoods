...
@{
    ...
    RequiredModules      = @(@{ModuleName = 'PSWriteColor'; GUID = '0b0ba5c5-ec85-4c2b-a718-874e55a8bc3f'; ModuleVersion = '0.87.2'; }, 
        @{ModuleName = 'Connectimo'; GUID = 'e4f4f8a6-473e-4ba5-8166-480658c11421'; ModuleVersion = '0.0.6'; })
    ...
    'Find-UsersProxyAddressesStatus', 'Get-ADADministrativeGroups', 
    'Get-ADTrustAttributes', 'Get-WinADForestControllers', 
    'Get-WinADForestDetails', 'Get-WinADForestGUIDs', 
    ...
    'Get-ComputerSMBSharePermissions', 'Get-ComputerSplit', 
    ...
    'Convert-Identity', 'Convert-KeyToKeyValue', 
    ...
    'ConvertFrom-X500Address', 'ConvertTo-Identity', 
    'ConvertTo-ImmutableID', 'ConvertTo-OperatingSystem', 
    'ConvertTo-OrderedDictionary', 'ConvertTo-SID', 
    ...
    'Get-FileInformation', 'Get-FileMetaData', 'Get-FileName', 
    'Get-FileOwner', 'Get-FilePermission', 'Get-FilesInFolder', 
    'Get-FileSize', 'Get-PathSeparator', 'Get-PathTemporary', 
    'Get-TemporaryDirectory', 'Remove-FilePermission', 
    'Set-FileInheritance', 'Set-FileOwner', 'Set-FilePermission', 
    ...
    'Compare-ObjectProperties', 'Copy-Dictionary', 
    'Copy-DictionaryManual', 'Format-AddSpaceToSentence', 
    ...
    'New-GenericList', 'Remove-DuplicateObjects', 'Remove-EmptyValue', 
    ...
    'Get-CommandInfo', 'Get-PSRegistry', 'Set-PSRegistry', 'New-Runspace', 
    'Start-Runspace', 'Stop-Runspace', 'Get-PSService', 
    ...
    'Get-FilePermissions', 'Copy-Hashtable', 'Copy-OrderedHashtable', 'FS', 
    'Format-TableStream', 'Format-ListStream', 'FV', 'Format-Verbose', 
    'Format-Debug', 'Format-Warning', 'Remove-EmptyValues', 
    'Remove-StringLatinCharacters', 'Set-Recovery', 
