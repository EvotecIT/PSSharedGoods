...
@{
    ...
    RequiredModules      = @(@{ModuleName = 'PSWriteColor'; GUID = '0b0ba5c5-ec85-4c2b-a718-874e55a8bc3f'; ModuleVersion = 'Latest'; },
        @{ModuleName = 'Connectimo'; GUID = 'e4f4f8a6-473e-4ba5-8166-480658c11421'; ModuleVersion = 'Latest'; })
    ...
    'Get-FileInformation', 'Get-FileName', 'Get-FilePermissions',
    'Get-FilesInFolder', 'Get-FileSize', 'Get-PathSeparator',
    'Get-PathTemporary', 'Get-TemporaryDirectory',
